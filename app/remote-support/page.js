...
const faqs = [
  {
    q: "Is this safe?",
    a: "Absolutely. You're in total control the entire time. You can see everything happening on your computer, and you can end the session at any second by closing the app. All connections use encrypted tunnels to keep your data safe.",
  },
  {
    q: "Do I need to install anything permanently?",
    a: "No. You can delete the app after the session. It doesn't run in the background and leaves nothing behind.",
  },
  {
    q: "What if I'm not tech-savvy?",
    a: "Just download the app, open it, and call us. We'll walk you through the rest — that's literally all you need to do.",
  },
  {
    q: "How much does a remote session cost?",
    a: "$100/hour, same as on-site — and no drive time means we get to work right away. Most common fixes are handled within 30–60 minutes.",
  },
  {
    q: "What happens after the session?",
    a: "Once you close the remote support app, it completely disconnects. We cannot reconnect unless you open the app again and provide a brand new, one-time password generated by the software.",
  },
  {
    q: "How does remote support work?",
    a: "We connect directly to your computer using a secure screen-sharing tool. You can watch everything we do in real time. Most sessions wrap up in under an hour. Available to clients in Fairplay, Breckenridge, Buena Vista, Leadville, and anywhere with an internet connection.",
  },
  {
    q: "Do I need to install anything for remote support?",
    a: "You'll download a small temporary app that lets us connect — we'll walk you through it on the call. It doesn't stay on your computer after the session.",
  },
  {
    q: "What can you fix remotely?",
    a: "Most software issues — virus and malware removal, email setup, software installs, printer configuration, troubleshooting, and general cleanup. We remotely support clients in Fairplay, Breckenridge, Frisco, Dillon, Buena Vista, Leadville, Salida, and beyond. If it turns out to be a hardware problem, we'll let you know and schedule an on-site visit.",
  },
  {
    q: "Do you offer remote support outside your service area?",
    a: "Yes. Remote support is available anywhere with an internet connection — you don't have to be in Fairplay, Breckenridge, or even Colorado. If you can get online, we can help.",
  },
];
        ...
        <div className="max-w-3xl mx-auto px-6 md:px-8">
          ...
          <div className="space-y-4">
            ...
            <details className="group glass-card rounded-xl overflow-hidden">
              ...
              <div className="px-6 md:px-8 pb-6 md:pb-8 text-frost-gray leading-relaxed">
                We connect directly to your computer using a secure
                screen-sharing tool. You can watch everything we do in real
                time. Most sessions wrap up in under an hour. Available to
                clients in Fairplay, Breckenridge, Buena Vista, Leadville, and
            ...
            <details className="group glass-card rounded-xl overflow-hidden">
              ...
              <div className="px-6 md:px-8 pb-6 md:pb-8 text-frost-gray leading-relaxed">
                You&apos;ll download a small temporary app that lets us
                connect &mdash; we&apos;ll walk you through it on the call. It
                doesn&apos;t stay on your computer after the session.
              </div>
            </details>
            ...
            <details className="group glass-card rounded-xl overflow-hidden">
              ...
              <div className="px-6 md:px-8 pb-6 md:pb-8 text-frost-gray leading-relaxed">
                Most software issues &mdash; virus and malware removal, email
                setup, software installs, printer configuration,
                troubleshooting, and general cleanup. We remotely support
                clients in Fairplay, Breckenridge, Frisco, Dillon, Buena Vista,
                Leadville, Salida, and beyond. If it turns out to be a hardware
                problem, we&apos;ll let you know and schedule an on-site visit.
              </div>
            </details>
            ...
            <details className="group glass-card rounded-xl overflow-hidden">
              <summary className="flex justify-between items-center p-6 md:p-8 cursor-pointer list-none">
                <h3 className="font-heading font-bold text-lg pr-4 text-snow-white">
                  Do you offer remote support outside your service area?
                </h3>
                <span className="material-symbols-outlined group-open:rotate-180 transition-transform text-vivid-teal shrink-0" aria-hidden="true">
                  expand_more
                </span>
              ...
              <div className="px-6 md:px-8 pb-6 md:pb-8 text-frost-gray leading-relaxed">
                Yes. Remote support is available anywhere with an internet
                connection &mdash; you don&apos;t have to be in Fairplay,
                Breckenridge, or even Colorado. If you can get online, we can
                help.
              </div>
            </details>
          </div>
